...
export class MedicamentosController {
    ...
    gestionarMedicamentos(@Param() params, @Headers() headers, @Request() request, @Response() response) {
        id= Number(params.id);
    ...
    buscarMedicamento(@Param() params,@Res() res,
        ...
        console.log('impiendo arreglo productos:',arregloMedicamentoBusqueda);
